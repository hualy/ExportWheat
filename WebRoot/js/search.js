$(function(){
    ...
    var myChart = echarts.init(document.getElementById('content'),'macarons');
     ...
     postMSM = function(site,startYear,endYear){
        // alert(5);
        $.post("getDetailInfor",
            {"site":site,"startYear":startYear,"endYear":endYear},
            // dataType:"xml",
            // async:false,
            function(returnedData,status){
                // alert(6);
                var colors = ['#5793f3', '#d14a61', '#675bba',"#e456fd"];
                // alert(7);
                var choice = {
                    title:{
                        show:true,
                        text: returnedData.title,
                        x:'center',
                        textStyle: {
                            color: '#000000'
                        },
                ...
                legend: {
                    data:['光温生产潜力','气候生产潜力','生育期内需水量','降水盈亏量']
                },
                xAxis: [
                    {
                        type: 'category',
                ...
                yAxis: [
                    {
                        ...
                        min: returnedData.ltppsMin,
                        max: returnedData.ltppsMax,
                        position: 'right',
                        axisLine: {
                            lineStyle: {
                                color: colors[0]
                    ...
                    },
                    {
                        ...
                        nameLocation:"start",
                        min: returnedData.cppsMin,
                        max: returnedData.cppsMax,
                        position: 'right',
                        offset: 83,
                        axisLine: {
                            lineStyle: {
                    ...
                    },
                    {
                        type: 'value',
                        name: '降水盈亏量/ml',
                        min: returnedData.rainfallsMin,
                        max: returnedData.rainfallsMax,
                        position: 'right',
                        offset: 126,
                        axisLine: {
                            lineStyle: {
                    ...
                    },
                    {
                        ...
                        max: returnedData.paniclesesMax,
                        position: 'left',
                        axisLine: {
                            lineStyle: {
                                color: colors[2]
                ...
                series: [
                    {
                        name:'光温生产潜力',
                        type:'bar',
                        data:returnedData.ltpps
                    },
                    {
                        name:'气候生产潜力',
                        type:'bar',
                        yAxisIndex: 1,
                        data:returnedData.cpps
                    },
                    {
                        name:'生育期内需水量',
                        type:'bar',
                        yAxisIndex: 3,
                        data:returnedData.panicleses
                    },
                    {
                        name:'降水盈亏量',
                        type:'line',
                        yAxisIndex: 2,
                        data:returnedData.rainfalls
                    }
                ]
            };
                // alert(8);
    ...
    getDatilMSM = function(){
        ...
        // alert(3);
        postMSM(site,startYear,endYear);
        // alert(4);
